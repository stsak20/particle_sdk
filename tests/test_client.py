...
def _get_open_connections(client: ParticleSDK | AsyncParticleSDK) -> int:
...
class TestParticleSDK:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "particle_sdk/_legacy_response.py",
                        "particle_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "particle_sdk/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: ParticleSDK) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: ParticleSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: ParticleSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: ParticleSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_omit_retry_count_header(
        self, client: ParticleSDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncParticleSDK:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncParticleSDK) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncParticleSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncParticleSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncParticleSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncParticleSDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from particle_sdk._utils import asyncify
        from particle_sdk._base_client import get_platform
