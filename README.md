...
pip install git+ssh://git@github.com/stsak20/particle_sdk.git
```
...
These methods return an [`APIResponse`](https://github.com/stsak20/particle_sdk/tree/main/src/particle_sdk/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/stsak20/particle_sdk/tree/main/src/particle_sdk/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/stsak20/particle_sdk/issues) with questions, bugs, or suggestions.
